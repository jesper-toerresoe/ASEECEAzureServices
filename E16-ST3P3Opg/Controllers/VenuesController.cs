...
using E16_ST3P3Opg.Models;

namespace E16_ST3P3Opg.Controllers
{
    public class VenuesController : ApiController
    {
        private E16_ST3P3OpgContext db = new E16_ST3P3OpgContext();

        // GET: api/Venues
        public IQueryable<Venue> GetVenues()
        {
            return db.Venues.Include(v => v.CommingEvents);
        }
